...
{
    public class Used_In_Components
    {
        [Fact]
        ...
        public void Sets_Values_In_ViewModel_As_Expected()
        {
            ...
            using var renderedComponent = ctx.RenderComponent<SilentView>(
                (ComponentParameterCollectionBuilder<SilentView> builder) =>
                {
                    builder.Add((SilentView demo) => demo.Id, 2);
                    builder.Add((SilentView demo) => demo.FullName, "Jane Doe");
                });
